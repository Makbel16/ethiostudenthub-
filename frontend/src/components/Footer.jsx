export default function Footer() {
  return (
    <footer className="mt-24 border-t border-line bg-white dark:border-dark-border dark:bg-dark-surface">
      <div className="page-shell py-12">
        <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div>
            <p className="font-display text-2xl font-semibold text-ink dark:text-dark-text">EthioStudentHub</p>
            <p className="mt-3 max-w-sm text-sm leading-6 text-muted dark:text-dark-muted">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted dark:text-dark-muted">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-line pt-6 text-xs text-muted sm:flex-row sm:items-center sm:justify-between dark:border-dark-border dark:text-dark-muted">
